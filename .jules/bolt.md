...
## 2025-05-21 - Three.js Performance Buffer Reallocation
**Learning:** In React Three Fiber, dynamically setting or replacing buffer attributes (like colors array) inside the render loop triggers a full geometry rebuild and causes frame stutters.
