...
## 2024-05-25 - ARIA Labels and Focus Rings on Icon Buttons
**Learning:** Foundational accessibility patterns like focus-visible outlines and ARIA labels are frequently missed on icon-only control buttons, impacting keyboard navigators and screen readers.
**Action:** Always ensure purely visual buttons have accessible text equivalents and clear focus boundaries by applying utility classes like `focus-visible:ring-2` and attributes like `aria-label`.
