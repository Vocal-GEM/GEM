...
**Learning:** Icon-only mobile toggle buttons often lack aria labels and clear focus states, making them inaccessible to screen readers and keyboard users.
**Action:** Always add aria-label, title, aria-expanded, and focus-visible utilities to mobile toggle buttons.
