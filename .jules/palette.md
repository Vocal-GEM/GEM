...
## 2024-10-24 - Dynamic ARIA labels on stateful buttons
**Learning:** Stateful icon buttons require dynamic ARIA labels to maintain context.
**Action:** Always bind aria-label attributes to the state variable controlling the icon.
