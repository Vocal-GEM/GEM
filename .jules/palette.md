...
## 2026-07-09 - Focus indicators on interactive elements
**Learning:** Purely visual icon-only buttons often lack proper accessibility indicators for keyboard users.
**Action:** Always add `focus-visible:ring-2 focus-visible:outline-none` and a descriptive `aria-label` to icon-only buttons to ensure they can be easily navigated and understood.
