...
## 2024-05-25 - Fixing ESLint Errors
**Learning:** Always escape quotes in JSX text blocks using HTML entities to prevent rendering issues and ensure screen readers announce the text correctly.
**Action:** Systematically replace all unescaped quotes with `&quot;` and `&apos;` in JSX.
