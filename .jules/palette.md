...
**Learning:** Icon-only buttons lacking `aria-label` text significantly impact keyboard accessibility and screen-reader usability.
**Action:** Added explicit `aria-label`s reflecting standard screen reader and keyboard accessibility practices across various app views.
