...
## 2025-02-18 - Mobile Toggle Accessibility
**Learning:** Icon-only mobile toggle buttons often lack aria-labels and focus indicators, making them completely inaccessible to screen reader and keyboard users.
**Action:** Always add dynamic aria-labels (e.g., "Open menu" / "Close menu") and focus-visible utilities to mobile toggle buttons.
