...
export class AudioEngine {
    ...
    startProcessing() {
        ...
        // Replaced raw requestAnimationFrame with centralized RenderCoordinator.
        // This consolidates multiple independent animation loops into a single subscriber system,
        // reducing CPU overhead and improving frame pacing across the application.
        this.unsubscribeRender = renderCoordinator.subscribe('audio-engine', loop, renderCoordinator.PRIORITY.CRITICAL);
    }
