...
export class AudioEngine {
    ...
    startProcessing() {
        ...
        const loop = (deltaTime, currentTime) => {
            if (!this.isActive) return;
        ...
        // Start the loop via RenderCoordinator
        renderCoordinator.subscribe('AudioEngine', loop, renderCoordinator.PRIORITY.HIGH);
    }
    ...
    stop() {
        ...
        // Unsubscribe from RenderCoordinator
        renderCoordinator.unsubscribe('AudioEngine');
        if (this.microphone) {
