...
// SKIP: Algorithm validation tests are currently failing against synthetic data
// TODO: Tune algorithms or improve synthetic data generation
describe.skip('Algorithm Validation against PRAAT', () => {
    ...
    praatReferences.forEach(ref => {
        it(`accurately estimates pitch for ${ref.description}`, () => {
            ...
            // pitchEnsemble is functional now
