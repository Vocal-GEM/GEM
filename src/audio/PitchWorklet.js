    ...
    process(inputs, _outputs, _parameters) {
        ...
        for (let i = 0; i < inputChannel.length; i++) {
            ...
            if (this.bufferIndex >= this.bufferSize) {
                const cTime = typeof globalThis.currentTime !== 'undefined' ? globalThis.currentTime : Date.now() / 1000;
                const pTime = typeof performance !== 'undefined' ? performance.now() : Date.now();
                ...
                const processingTime = endTime - startTime; // Already in ms
