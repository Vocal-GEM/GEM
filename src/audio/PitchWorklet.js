...
typeof currentTime !== 'undefined' ? currentTime : performance.now() / 1000;

                // Detect pitch using YIN algorithm
                const result = this.detectPitchYIN(this.buffer);

                const processingTime = ((// eslint-disable-next-line no-undef
typeof currentTime !== 'undefined' ? currentTime : performance.now() / 1000) - startTime) * 1000; // Convert to ms
                ...
                this.port.postMessage({
                    ...
                    timestamp: // eslint-disable-next-line no-undef
typeof currentTime !== 'undefined' ? currentTime : performance.now() / 1000,
