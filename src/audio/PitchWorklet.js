    ...
    process(inputs, _outputs, _parameters) {
        ...
        for (let i = 0; i < inputChannel.length; i++) {
            ...
            if (this.bufferIndex >= this.bufferSize) {
                // Use globalThis.currentTime if available, otherwise assume implicit global
                // In AudioWorklet, currentTime is a global property.
                // ESLint might complain if env is not configured.
                // Using globalThis.currentTime should be safe.
