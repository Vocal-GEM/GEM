    ...
    process(inputs, _outputs, _parameters) {
        ...
        for (let i = 0; i < inputChannel.length; i++) {
            ...
            if (this.bufferIndex >= this.bufferSize) {
                // Use globalThis.currentTime if available, otherwise just use 0 (or performance.now() if supported, but Worklet scope is limited)
                // In AudioWorkletGlobalScope, 'currentTime' is a global variable.
