    ...
    process(inputs, outputs, parameters) {
        ...
        for (let i = 0; i < inputChannel.length; i++) {
            ...
            if (this.bufferIndex >= this.bufferSize) {
                ...
                const safeTime = typeof currentTime !== 'undefined' ? currentTime : Date.now() / 1000;
                ...
                // eslint-disable-next-line no-undef
                const endSafeTime = typeof currentTime !== 'undefined' ? currentTime : Date.now() / 1000;
                const processingTime = (endSafeTime - startTime) * 1000; // Convert to ms
