...
class PitchProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs, parameters) {
        // Fallback for environments where currentTime is not defined
        const _currentTime = typeof globalThis.currentTime !== "undefined" ? globalThis.currentTime : Date.now() / 1000;
        ...
        for (let i = 0; i < inputChannel.length; i++) {
            ...
            if (this.bufferIndex >= this.bufferSize) {
                ...
                const processingTime = (_currentTime - startTime) * 1000; // Convert to ms
