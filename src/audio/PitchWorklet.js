    ...
    process(inputs, outputs, parameters) {
        ...
        for (let i = 0; i < inputChannel.length; i++) {
            ...
            if (this.bufferIndex >= this.bufferSize) {
                ...
                const safeTime = typeof currentTime !== 'undefined' ? currentTime : performance.now() / 1000;
                ...
                // eslint-disable-next-line no-undef
                const processingTime = ((typeof currentTime !== 'undefined' ? currentTime : performance.now() / 1000) - startTime) * 1000; // Convert to ms
