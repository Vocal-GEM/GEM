...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const salt = this.studyId + (typeof process !== 'undefined' && process.env && process.env.REACT_APP_RESEARCH_SALT ? process.env.REACT_APP_RESEARCH_SALT : 'default_fallback_salt');
