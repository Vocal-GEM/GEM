...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const salt = this.studyId + (typeof process !== 'undefined' && process.env.REACT_APP_RESEARCH_SALT ? process.env.REACT_APP_RESEARCH_SALT : import.meta.env.VITE_RESEARCH_SALT);
