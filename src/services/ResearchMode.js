...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        // Use import.meta.env for Vite compatibility, fallback to default for dev/test
        const salt = this.studyId + (import.meta.env.VITE_RESEARCH_SALT || 'default_research_salt');
