...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const salt = this.studyId + (import.meta.env.VITE_RESEARCH_SALT || (typeof process !== 'undefined' && process.env && process.env.REACT_APP_RESEARCH_SALT) || 'default-research-salt');
