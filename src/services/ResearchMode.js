...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const envSalt = typeof process !== 'undefined' && process.env.REACT_APP_RESEARCH_SALT ? process.env.REACT_APP_RESEARCH_SALT : import.meta.env.VITE_RESEARCH_SALT;
        if (!envSalt) {
            throw new Error("Missing research salt in environment variables");
        }
