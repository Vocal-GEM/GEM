...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const salt = this.studyId + (typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.VITE_RESEARCH_SALT ? import.meta.env.VITE_RESEARCH_SALT : 'fallback_salt');
