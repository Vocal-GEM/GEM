...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        // Use import.meta.env for Vite environment, fallback to process.env if needed (though process is not defined in browser)
        const salt = this.studyId + (import.meta.env.VITE_RESEARCH_SALT || 'dev-salt');
