...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const envSalt = (typeof process !== 'undefined' && process.env && process.env.REACT_APP_RESEARCH_SALT) || (import.meta.env && import.meta.env.VITE_RESEARCH_SALT) || 'default-salt';
