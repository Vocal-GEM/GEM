...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const appSalt = typeof process !== 'undefined' && process.env ? process.env.REACT_APP_RESEARCH_SALT : (import.meta.env ? import.meta.env.VITE_APP_RESEARCH_SALT : 'default_salt');
