...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const salt = this.studyId + globalThis.process.env.REACT_APP_RESEARCH_SALT;
    ...
    async withdrawParticipant(participantId, reason = 'participant_request') {
        ...
        await this.globalThis.processWithdrawal(withdrawal);
    ...
    async globalThis.processWithdrawal(withdrawal) {
        // TODO: Implement backend API call
