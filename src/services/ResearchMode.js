...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const envSalt = typeof import.meta !== 'undefined' && import.meta.env ? import.meta.env.VITE_RESEARCH_SALT : (typeof process !== 'undefined' && process.env ? process.env.REACT_APP_RESEARCH_SALT : 'default-salt');
