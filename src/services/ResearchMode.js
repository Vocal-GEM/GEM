...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        // Use string literal fallback to avoid process is not defined errors in browser
        const envSalt = typeof import.meta !== 'undefined' && import.meta.env ? import.meta.env.VITE_RESEARCH_SALT : "default_salt";
