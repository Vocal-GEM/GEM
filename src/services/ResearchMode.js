...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        // Using Vite environment variables or a fallback for testing
        const envSalt = (typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.VITE_RESEARCH_SALT)
            // eslint-disable-next-line no-undef
            || (typeof process !== 'undefined' && process.env.REACT_APP_RESEARCH_SALT)
            || 'default_salt';
