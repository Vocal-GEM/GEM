...
export class ResearchModeController {
    ...
    generateParticipantId(userId) {
        ...
        const researchSalt = typeof process !== 'undefined' && process.env ? process.env.REACT_APP_RESEARCH_SALT : import.meta.env.VITE_RESEARCH_SALT;
        const salt = this.studyId + (researchSalt || 'default_salt');
