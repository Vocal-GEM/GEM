...
const RegisterGauge = ({ dataRef, showHint = true }) => {
    ...
    const componentId = useRef('RegisterGauge-' + Math.random().toString(36).substr(2, 9)).current;
    ...
    useEffect(() => {
        ...
        // ⚡ Bolt Optimization: Subscribe to RenderCoordinator instead of using raw requestAnimationFrame
        // This consolidates multiple independent animation loops, preventing layout thrashing and high CPU usage.
