        ...
        <div className="bg-slate-900/50 rounded-2xl p-5 border border-slate-800">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <button
                    ...
                    aria-describedby={showTooltip ? "brightness-meter-tooltip" : undefined}
                    className="text-slate-600 hover:text-slate-300 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded"
            ...
            {showTooltip && (
                <div
                    id="brightness-meter-tooltip"
                    role="tooltip"
                    className="absolute z-50 mt-2 p-3 bg-slate-900/95 backdrop-blur border border-white/10 rounded-lg text-xs text-slate-300 max-w-xs shadow-xl"
                >
