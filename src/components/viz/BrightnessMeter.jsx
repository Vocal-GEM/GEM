    ...
    return (
        <div className="bg-slate-900/50 rounded-2xl p-5 border border-slate-800">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <button
                    className="text-slate-600 hover:text-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 transition-colors rounded p-0.5"
                    onMouseEnter={() => setShowTooltip(true)}
                    onMouseLeave={() => setShowTooltip(false)}
                    onFocus={() => setShowTooltip(true)}
                    onBlur={() => setShowTooltip(false)}
                    aria-label="Toggle brightness meter information"
                >
                    <Info size={16} />
                </button>
            </div>
