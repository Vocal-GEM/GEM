...
describe('Spectrogram3D', () => {
    ...
    it('runs the animation loop safely', () => {
        ...
        // Note: In a real test we'd want to mock the meshRef properly, but for this smoke test
        // we just want to ensure the useFrame hook doesn't crash on invocation.
