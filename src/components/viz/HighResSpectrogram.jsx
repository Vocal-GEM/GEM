    ...
    useEffect(() => {
        ...
        const updateSize = () => {
            ...
            if (canvas.width !== newWidth || canvas.height !== newHeight) {
                ...
                // Optimization: Height is always 512, and scrollSpeed is fixed.
                // Reusing imgDataRef & data32Ref prevents a new Float32Array
                // allocation on every UI layout shift, completely avoiding GC churn.
            }
        };
