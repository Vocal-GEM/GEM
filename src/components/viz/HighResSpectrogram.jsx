...
const HighResSpectrogram = memo(function HighResSpectrogram({ dataRef }) {
    ...
    // Initial canvas setup & Handle Resize with ResizeObserver
    useEffect(() => {
        ...
        const resizeObserver = new ResizeObserver((entries) => {
            ...
            requestAnimationFrame(() => {
                for (const entry of entries) {
                    ...
                    // Read dimensions from ResizeObserverEntry instead of getBoundingClientRect
                    // to avoid synchronous layout thrashing
