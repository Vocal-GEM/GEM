...
const HighResSpectrogram = memo(function HighResSpectrogram({ dataRef }) {
    ...
    const draw = useCallback(() => {
        ...
        // Bolt Performance Optimization: Removed duplicate getContext call and redundant drawing commands
        // created by unresolved merge conflicts. This prevents recreating the canvas context twice per frame
        // and executing redundant drawImage calls, saving ~2ms per render cycle and reducing memory churn.
