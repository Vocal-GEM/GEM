...
const HighResSpectrogram = memo(function HighResSpectrogram({ dataRef }) {
    ...
    // Optimization: Pre-calculated bin index map to avoid division in render loop
    ...
    const draw = useCallback(() => {
        ...
        if (!binMapRef.current ||
            lastMapParamsRef.current.height !== height ||
            ...
            lastMapParamsRef.current = { height, maxBin };
        }
    ...
    useEffect(() => {
        ...
        const updateSize = () => {
            ...
            if (canvas.width !== newWidth || canvas.height !== newHeight) {
                ...
                // Force map update
                lastMapParamsRef.current = { height: 0, maxBin: 0 };
            }
        };
