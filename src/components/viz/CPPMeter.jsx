    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            ...
            if (audioData && audioData.length > 0) {
                ...
                // OPTIMIZATION: Reuse Float32Array buffer to avoid garbage collection pauses on every interval tick.
                // Reduces memory allocation overhead significantly during high-frequency updates.
