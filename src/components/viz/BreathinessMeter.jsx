...
import { Wind, CheckCircle2, AlertTriangle, Info, Activity, HelpCircle, Sparkles } from 'lucide-react';
                ...
                <div className="mt-4 bg-slate-900/50 rounded-xl p-4 border border-white/5">
                    ...
                    <div className="mt-3 flex items-center justify-center gap-4 text-[10px]">
                        <div className="flex items-center gap-1">
                            <div className={`w-2 h-2 rounded-full ${colorBlindMode ? 'text-teal-400' : 'bg-emerald-400'}`} />
