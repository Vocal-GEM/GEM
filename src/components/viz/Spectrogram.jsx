        ...
        >
            ...
            {showControls && (
                <button
                    ...
                    className="absolute top-2 right-2 p-2 bg-slate-900/80 hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-lg text-white/70 hover:text-white transition-all z-10 animate-in fade-in duration-200"
