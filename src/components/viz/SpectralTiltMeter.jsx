    ...
    useEffect(() => {
        const loop = () => {
            if (indicatorRef.current && valueRef.current) {
                const tilt = dataRef.current ? (dataRef.current.tilt || 0) : 0;
                ...
                // We'll handle class changes carefully to avoid thrashing,
                // but direct DOM manipulation is fast enough here.
                // Or better, keep classes static and change colors via style or specific elements.
            }
        };
