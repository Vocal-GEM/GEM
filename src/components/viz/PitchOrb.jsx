...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    useEffect(() => {
        ...
        // Use ResizeObserver to detect changes without layout thrashing in the loop
        ...
        const loop = () => {
            ...
            // OPTIMIZED: Use cached dimensions to avoid layout thrashing (getBoundingClientRect)
