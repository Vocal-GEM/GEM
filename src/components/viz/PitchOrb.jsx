...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    // Cache dimensions to avoid layout thrashing in the render loop
    ...
    useEffect(() => {
        ...
        const updateDimensions = () => {
            ...
            // Store logical dimensions for the render loop
            dimensionsRef.current = {
                width: rect.width,
                height: rect.height
            };

            // Restore scale after resizing clears the canvas state
            ctx.scale(dpr, dpr);
        };
        ...
        const loop = () => {
            ...
            // Clear canvas properly using logical dimensions
            // Avoid changing canvas.width here as it forces a full repaint and reset
