...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    // Handle Canvas Resize Asynchronously
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const loop = () => {
            ...
            // Important: we cannot assume canvas retains its state or clears itself if we removed canvas.width assignment.
            // Explicitly clear the rect
