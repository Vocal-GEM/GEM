...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    useEffect(() => {
        ...
        // BOLT OPTIMIZATION: Use ResizeObserver instead of synchronous getBoundingClientRect
        // Expected Impact: Eliminates ~60 synchronous reflows/layout recalcs per second
        // Measurement: View Chrome DevTools Performance tab, look for "Recalculate Style" events
