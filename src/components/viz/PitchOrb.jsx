...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    // Handle Canvas Size: Optimization to prevent layout thrashing
    // by moving getBoundingClientRect out of the animation loop
    useEffect(() => {
        ...
        const updateDimensions = (entries) => {
            ...
            if (entries && entries.length > 0) {
                // Use contentRect from ResizeObserver to avoid getBoundingClientRect
