...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    // Optimization: Monitor canvas size asynchronously with ResizeObserver
    // to prevent synchronous layout thrashing (getBoundingClientRect) inside the animation loop.
    useEffect(() => {
