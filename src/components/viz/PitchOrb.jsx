...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    useEffect(() => {
        ...
        const resizeObserver = new ResizeObserver((entries) => {
            ...
            // Get physical dimensions (entry.contentRect provides unscaled width/height)
            // But getBoundingClientRect is safer for initial size, or just use entry.contentRect
        ...
        const loop = () => {
            ...
            // Only update canvas dimensions if they changed to avoid clear/reflow
