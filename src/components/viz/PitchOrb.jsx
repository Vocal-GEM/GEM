...
const PitchOrb = ({ dataRef, settings = {} }) => {
    ...
    useEffect(() => {
        ...
        // Optimization: Use ResizeObserver to avoid layout thrashing in the animation loop
        const resizeObserver = new ResizeObserver((entries) => {
            for (const entry of entries) {
                const { width, height } = entry.contentRect;
                dimensionsRef.current = { width, height };

                // Update canvas size only when dimensions actually change
        ...
        const loop = () => {
            ...
            // Use cached dimensions to avoid getBoundingClientRect()
