...
const LiveMetricsBar = ({ dataRef }) => {
    // ⚡ Bolt Optimization: Replaced useState with useRef for CRITICAL priority (~60fps) loop.
    // Direct DOM manipulation bypasses React reconciliation entirely, saving ~60 renders/sec.
...
export default memo(LiveMetricsBar);
