...
const LiveMetricsBar = memo(function LiveMetricsBar({ dataRef }) {
    ...
    useEffect(() => {
        const loop = () => {
            if (dataRef.current) {
                ...
                // PERFORMANCE OPTIMIZATION: Direct DOM updates instead of React state
                // This prevents the component from re-rendering on every audio frame
