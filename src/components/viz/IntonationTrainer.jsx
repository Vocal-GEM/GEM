        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 p-4">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2">
                    <button onClick={() => setShowHistory(!showHistory)} aria-label={showHistory ? "Hide History" : "Show History"} className={`p-1.5 rounded hover:bg-slate-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 ${showHistory ? 'text-blue-400' : 'text-slate-400'}`}>
                        <History size={16} />
                    </button>
                    <div className="flex items-center bg-slate-800 rounded px-1">
                        <button onClick={prevPattern} aria-label="Previous Pattern" className="p-1 hover:bg-slate-700 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"><ChevronLeft className="w-4 h-4 text-slate-400" /></button>
                        <span className="text-xs text-slate-300 font-mono w-4 text-center">{selectedPattern + 1}</span>
                        <button onClick={nextPattern} aria-label="Next Pattern" className="p-1 hover:bg-slate-700 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"><ChevronRight className="w-4 h-4 text-slate-400" /></button>
                    </div>
                </div>
            </div>
