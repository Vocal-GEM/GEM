        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 p-4">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2">
                    <button onClick={() => setShowHistory(!showHistory)} aria-label={showHistory ? "Hide history" : "Show history"} aria-expanded={showHistory} className={`p-1.5 rounded hover:bg-slate-800 ${showHistory ? 'text-blue-400' : 'text-slate-400'}`}>
                        <History size={16} />
                    </button>
