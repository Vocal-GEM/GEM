...
vi.mock('lucide-react', () => {
    // Return mock components directly without using require
    const MockIcon = ({ 'data-testid': testId, ...props }) => React.createElement('div', { 'data-testid': testId, ...props });
    MockIcon.displayName = 'MockIcon';

    const createIcon = (name) => {
        const Icon = (props) => React.createElement(MockIcon, { 'data-testid': name, ...props });
