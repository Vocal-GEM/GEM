    ...
    return (
        <div className="absolute bottom-4 right-4 z-30">
            <button
                ...
                aria-controls="orb-legend-content"
            ...
            {isOpen && (
                <div id="orb-legend-content" className="absolute right-0 bottom-12 w-80 sm:w-96 bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-xl p-5 shadow-2xl animate-in fade-in slide-in-from-bottom-2 duration-200">
