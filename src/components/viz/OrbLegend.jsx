    ...
    return (
        <div className="absolute bottom-4 right-4 z-30">
            <button
                ...
                className={`p-2 rounded-full backdrop-blur-md border transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-teal-400 ${isOpen ? 'bg-teal-500 text-white border-teal-400' : 'bg-slate-800/50 border-white/10 text-white/70 hover:bg-slate-700/50'}`}
                aria-label={isOpen ? 'Close visual key legend' : 'Open visual key legend'}
