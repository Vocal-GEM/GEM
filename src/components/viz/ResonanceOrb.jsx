    ...
    useEffect(() => {
        const loop = () => {
            if (orbRef.current) {
                ...
                let rPercent = 0;
                if (resonance > 0) { rPercent = ((resonance - minC) / (maxC - minC)); rPercent = Math.max(0, Math.min(1, rPercent)); }
                ...
                if (labelRef.current) {
                    ...
                    else if (rPercent > 0.7) labelRef.current.innerText = "Bright / Head";
                    else if (rPercent < 0.3) labelRef.current.innerText = "Dark / Chest";
