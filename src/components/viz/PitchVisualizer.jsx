...
const PitchVisualizer = memo(({ dataRef, targetRange, userMode, exercise, onScore, settings }) => {
    ...
    // Optimization: Lazy initialization of Image objects in useEffect
    ...
    useEffect(() => {
        // Optimization: Create Image objects once here instead of during render
            ...
            if (exercise && getExerciseFreq) {
                ...
                for (let i = 30; i < width; i += 5) {
                    ...
                    if (i % 150 === 0) {
                        ...
                        if (birdRef.current && birdRef.current.complete) {
                            ctx.drawImage(birdRef.current, i, birdY - 15, 30, 30);
                        }
                    }
                }
