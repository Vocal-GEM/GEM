...
const PitchVisualizer = memo(({ dataRef, targetRange, userMode, exercise, onScore, settings }) => {
    ...
    useEffect(() => {
        // Set sources for lazy-loaded images
        if (balloonRef.current) balloonRef.current.src = '/assets/balloon.png';
        if (birdRef.current) birdRef.current.src = '/assets/bird.png';
    }, []);
