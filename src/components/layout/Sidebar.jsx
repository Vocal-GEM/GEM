...
const Sidebar = ({ activeView, onViewChange }) => {
    ...
    return (
        <>
            ...
            {/* Sidebar Container */}
            <div id="mobile-navigation" className={`fixed inset-y-0 left-0 z-40 w-64 bg-slate-900 border-r border-slate-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
