...
// Use globalThis for Vitest environment compatibility
...
describe('SuccessStories', () => {
    ...
    test('shows toast on validation error', async () => {
        // Need empty stories to test form interaction without story list interference if desired,
        // but here we just want to open the form.
