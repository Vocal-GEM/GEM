...
describe('SuccessStories', () => {
    ...
    test('shows toast on validation error', async () => {
        // Need to simulate empty stories to get to empty state or just trigger modal from existing
        // Assuming we can trigger modal even if stories exist (yes, button is there)
        render(<SuccessStories />);
