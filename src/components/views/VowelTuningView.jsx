...
const VowelTuningView = () => {
    ...
    const vowels = {
        'i': { label: '/i/ (eee)', description: 'Bright & Forward', instruction: 'Smile slightly and raise your tongue.' },
        'a': { label: '/a/ (ah)', description: 'Open & Resonant', instruction: 'Drop your jaw and relax your tongue.' },
        'u': { label: '/u/ (ooo)', description: 'Dark & Round', instruction: 'Round your lips and create space in the back.' }
    };
        ...
        <div className="h-full flex flex-col gap-4 p-4">
            ...
            <div className="flex items-center justify-between shrink-0">
                <div>
                    ...
                    <p className="text-slate-400 text-sm">Fine-tune your vowel resonance targets</p>
                </div>
                <button
                ...
                >
                    {isRecording ? <><Mic className="w-4 h-4" /> Stop</> : <><Play className="w-4 h-4" /> Start Lab</>}
                </button>
            </div>
                ...
                <div className="lg:col-span-1 flex flex-col gap-4">
                    <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/50 flex-1">
                        <h3 className="text-white font-bold mb-4 flex items-center gap-2">
                            <Info className="w-4 h-4 text-blue-400" /> Target Vowel
                        </h3>
                        ...
                        <div className="mt-6 p-4 bg-blue-500/10 rounded-xl border border-blue-500/20">
                            <h4 className="text-blue-300 font-bold mb-2 text-sm">Coaching Tip</h4>
                    ...
                    {!isRecording && (
                        <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">Ready to Tune?</h3>
                                <p className="text-slate-400 mb-6">Select a vowel and hit Start to begin.</p>
                                <button
                                    onClick={toggleRecording}
