...
const PracticeMode = ({
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
            ...
            {/* Header / Controls */}
            <div className="flex flex-col lg:flex-row justify-between items-center mb-3 gap-3">
                <div id="practice-tabs" className="flex items-center gap-4 overflow-x-auto w-full lg:w-auto pb-2 lg:pb-0">
                    {TABS.map(tab => (
                        <button
                            key={tab.id}
