    ...
    return (
        <div className="w-full min-h-screen bg-slate-950 p-6">
            <div className="max-w-6xl mx-auto pt-12">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">Advanced Acoustic Analysis</h1>
                    <p className="text-slate-400">Objective measures for spectral balance, voice quality, and glottal efficiency.</p>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    {/* Vospector Module (Breathiness/Roughness) */}
                    <MetricCard
                        title="Breathiness (GNE)"
                        value={backendData.breathiness_score || 0}
                        unit="%"
                        icon={<Wind size={20} />}
                        color="text-blue-400"
                        description="Measures glottal noise. Higher values indicate more breathy voice."
                    />
                    <MetricCard
                        title="Roughness"
                        ...
                        description="Measures irregularity in vibration. Higher values indicate hoarseness."
                    />
                    <MetricCard
                        title="CPP (Cepstral Peak)"
                        value={backendData.cpp_mean || 0}
                        unit="dB"
                        icon={<Activity size={20} />}
                        color="text-emerald-400"
                        description="Cepstral Peak Prominence. Higher values indicate better vocal quality (less dysphonia)."
                    />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800">
                        ...
                        <div className="mt-4 text-sm text-slate-400">
                            Use LTAS to analyze the spectral tilt of your voice over time.
                            <ul className="list-disc list-inside mt-2 space-y-1">
                                <li><strong>Feminization:</strong> Look for more energy in high frequencies (right side).</li>
                                <li><strong>Masculinization:</strong> Look for more energy in low frequencies (left side).</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800">
                        ...
                        <div className="flex items-center justify-center h-64">
                            <div className="text-center">
                                ...
                                <div className="text-slate-400">Spectral Balance Score</div>
