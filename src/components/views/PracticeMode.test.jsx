...
// Ensure the mock component has a display name or is a simple function
...
describe('PracticeMode', () => {
    ...
    it('renders without crashing', async () => {
        ...
        // Wait for lazy components or effects
        // Using findByTestId handles potential async rendering
        const orb = await screen.findByTestId('dynamic-orb');
