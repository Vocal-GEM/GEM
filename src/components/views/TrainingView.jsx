    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex items-center gap-2 mb-6">
                <button
                    onClick={onBack}
                    className="p-2 hover:bg-slate-800 rounded-lg text-slate-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                            ...
                            <div className="flex items-start justify-between gap-2 mb-2">
                                ...
                                {isPerformanceCategory && supported && (
                                    <button
                                        ...
                                        className={`p-2 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 ${speaking ? 'bg-red-500/20 text-red-400 focus-visible:ring-red-400' : 'bg-slate-800 text-slate-400 hover:text-white focus-visible:ring-slate-400'}`}
                                        title={speaking ? 'Stop' : 'Hear Example'}
                                        aria-label={speaking ? 'Stop hearing example' : 'Hear example text'}
                                    >
                ...
                {activeModule ? (
                    ...
                    (!activeModule.component || activeModule.id.startsWith('pitch') || activeModule.id.startsWith('intonation')) && (
                        <button
                            ...
                            className="flex items-center gap-2 text-slate-400 hover:text-white mb-4 transition-colors rounded-lg px-2 py-1 -ml-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {techModules.map(module => (
                                    <button
                                        ...
                                        className="bg-slate-900 border border-slate-800 p-4 rounded-2xl text-left hover:border-teal-500/50 hover:bg-slate-800 transition-all group relative overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                                    >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                                {TRAINING_CATEGORIES.map(category => (
                                    <button
                                        ...
                                        className={`bg-slate-900 border border-slate-800 p-6 rounded-2xl text-left hover:border-${category.color}-500/50 hover:bg-slate-800 transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-${category.color}-500`}
                                    >
