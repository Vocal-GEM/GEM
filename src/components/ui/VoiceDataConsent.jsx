                        ...
                        <div className="p-3 bg-slate-800/50 rounded-xl border border-slate-700/50">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`w-12 h-6 rounded-full transition-colors relative focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-green-500 ${currentConsent.enabled ? 'bg-green-500' : 'bg-slate-700'
                                        }`}
                                >
                                    <div
                                ...
                                <div className="p-3 bg-slate-800/50 rounded-xl border border-slate-700/50 ml-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button
                                            ...
                                            className={`w-12 h-6 rounded-full transition-colors relative focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-blue-500 ${currentConsent.anonymousUpload ? 'bg-blue-500' : 'bg-slate-700'
                                                }`}
                                        >
                                            <div
                                ...
                                <div className="p-3 bg-slate-800/50 rounded-xl border border-slate-700/50 ml-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button
                                            ...
                                            className={`w-12 h-6 rounded-full transition-colors relative focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 focus-visible:ring-purple-500 ${currentConsent.includeGenderLabel ? 'bg-purple-500' : 'bg-slate-700'
                                                }`}
                                        >
                                            <div
