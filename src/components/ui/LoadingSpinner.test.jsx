...
describe("LoadingSpinner", () => {
  ...
  it("renders with different sizes", () => {
    ...
    // Check sm class or structure (implementation dependent, but ensuring it renders is key)
    expect(container.firstChild).toHaveClass('inline-flex'); // SM/XS often inline

    rerender(<LoadingSpinner size="xl" />);
    expect(screen.getByRole("status")).toBeInTheDocument();
    expect(container.firstChild).toHaveClass('flex'); // XL default flex
  });
