...
describe("LoadingSpinner", () => {
  ...
  it("renders with different sizes", () => {
    ...
    // Check sizing classes loosely or specific logic
    expect(container.firstChild).toHaveClass('inline-flex'); // sm implies inline usually

    rerender(<LoadingSpinner size="xl" />);
    expect(screen.getByRole("status")).toBeInTheDocument();
    expect(container.firstChild).toHaveClass('flex'); // default flex
  });
