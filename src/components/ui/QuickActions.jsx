        ...
        >
            ...
            <div
                ...
                className={twMerge(
                    ...
                    isOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10 pointer-events-none invisible"
                )}
                aria-hidden={!isOpen}
            >
                {actions.map((action, index) => (
                    ...
                    >
                        ...
                        <div
                            className={twMerge(
                                "w-12 h-12 rounded-full shadow-lg flex items-center justify-center text-white transition-transform hover:scale-110 group-focus-visible:scale-110 group-focus-visible:ring-2 group-focus-visible:ring-offset-2 group-focus-visible:ring-offset-slate-900",
                                action.color
                            )}
                        >
                            <action.icon size={20} />
