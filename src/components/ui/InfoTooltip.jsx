...
const InfoTooltip = ({ content, icon: Icon = HelpCircle, size = 16, className = "", ariaLabel = "More information" }) => {
    ...
    return (
        ...
        >
            <button
                type="button"
                className="focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 rounded-full flex items-center justify-center p-0.5 -m-0.5"
