                    ...
                    {isAddingMode ? (
                        <div className="bg-slate-800/30 rounded-xl p-4 border border-slate-700 border-dashed flex items-center gap-3">
                            ...
                            <button
                                ...
                                className="p-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
                            ...
                            <button
                                ...
                                className="p-2 text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:outline-none"
                                aria-label="Cancel"
                                title="Cancel"
                            >
                                <Trash2 size={16} />
