...
const HistoryView = ({ stats, journals, onLogClick, userMode }) => {
    ...
    // Bolt Optimization: Memoize chart configuration to prevent unnecessary React-ChartJS-2 re-renders
    // Expected impact: Eliminates expensive chart re-renders and O(n) array operations when unrelated component state changes (e.g. tabs).
    ...
    // Bolt Optimization: Memoize chart configuration to prevent unnecessary React-ChartJS-2 re-renders
    // Expected impact: Maintains referential equality of options object, eliminating chart canvas recreation on unrelated renders.
