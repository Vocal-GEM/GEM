...
const HistoryView = ({ stats, journals, onLogClick, userMode }) => {
    ...
    // Bolt Optimization: Memoize chart data to prevent unnecessary re-renders of the chart component
    ...
    // Bolt Optimization: Memoize chart configuration to prevent unnecessary re-renders of the chart component
