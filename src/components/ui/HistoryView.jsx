...
const HistoryView = ({ stats, journals, onLogClick, userMode }) => {
    ...
    // Bolt Optimization: Memoize Chart.js config to prevent expensive re-renders.
    // Expected impact: Eliminates unnecessary canvas re-draws on parent state updates, reducing main thread blocking.
