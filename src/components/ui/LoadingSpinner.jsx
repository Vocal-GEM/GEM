...
const LoadingSpinner = ({
  ...
  const variants = {
    default: {
      ...
      segment: "border-t-blue-500 border-r-transparent border-b-transparent border-l-transparent"
    },
    current: {
      track: "border-current opacity-20",
      segment: "border-t-current border-r-transparent border-b-transparent border-l-transparent"
    },
    white: {
      track: "border-white opacity-20",
      segment: "border-t-white border-r-transparent border-b-transparent border-l-transparent"
    }
  };
    ...
    <div
      ...
      className={twMerge(
        clsx(
          ...
          isSmall ? 'inline-flex w-auto h-auto min-h-0' : 'w-full h-full min-h-[200px]',
          className
        )
      )}
    >
