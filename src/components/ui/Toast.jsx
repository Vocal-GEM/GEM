  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className={clsx(
          'ml-2 hover:opacity-70 p-1 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-current transition-opacity',
          style.text
        )}
