...
export default function LoadingSpinnerVerification() {
  return (
    <div className="p-10 space-y-10 bg-slate-900 min-h-screen text-slate-100 pb-40">
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-wrap gap-4 mt-4">
          ...
          <Button size="icon" isLoading aria-label="Add item"><Plus /></Button>
        </div>
        <div className="flex flex-wrap gap-4 mt-4">
