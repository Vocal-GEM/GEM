...
import { User, Star, ThumbsUp, ThumbsDown, Plus, Trash2 } from 'lucide-react';
                            ...
                            <div className="flex items-start justify-between gap-4">
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    <button
                                        ...
                                        aria-label={voice.isTopPick ? `Remove ${voice.name} from top picks` : `Mark ${voice.name} as top pick`}
                                        aria-pressed={voice.isTopPick}
                                    >
                                        <Star size={20} fill={voice.isTopPick ? "currentColor" : "none"} aria-hidden="true" />
                                    </button>
                                    <button
                                        onClick={() => setVoices(prev => prev.filter(v => v.id !== voice.id))}
                                        className="p-2 text-slate-600 hover:text-red-400 transition-colors rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
                                        aria-label={`Remove ${voice.name} from list`}
                                    >
