...
const JournalForm = ({ onSubmit, onCancel }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="glass-panel p-4 rounded-2xl space-y-4 max-h-[80vh] overflow-y-auto">
            ...
            {/* Emotional Check-In */}
            <div role="radiogroup" aria-labelledby="sentiment-label">
                <label id="sentiment-label" className="text-xs font-bold text-slate-400 uppercase tracking-wider block mb-2">How does your voice feel?</label>
