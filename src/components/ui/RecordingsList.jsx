                ...
                <div key={recording.id} className="bg-slate-800/50 hover:bg-slate-800 border border-slate-700 rounded-xl p-4 transition-all group">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            aria-label={playingId === recording.id ? `Pause recording ${recording.name || 'Untitled Recording'}` : `Play recording ${recording.name || 'Untitled Recording'}`}
                        ...
                        <div className="flex-1 min-w-0">
                            {editingId === recording.id ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <button aria-label="Save recording name" onClick={() => saveEdit(recording)} className="p-1 hover:text-green-400 text-slate-400"><Check size={16} /></button>
                                    <button aria-label="Cancel editing recording name" onClick={cancelEdit} className="p-1 hover:text-red-400 text-slate-400"><X size={16} /></button>
                                </div>
                            ) : (
                                <div>
                                    <div className="flex items-center gap-2">
