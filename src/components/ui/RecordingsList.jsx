...
// ⚡ Bolt: Wrap in React.memo to prevent unnecessary re-renders when parent HistoryView state changes.
// The list relies entirely on internal state and context, so it does not need to re-render on parent updates.
