                ...
                <div key={recording.id} className="bg-slate-800/50 hover:bg-slate-800 border border-slate-700 rounded-xl p-4 transition-all group">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors flex-shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/50 ${playingId === recording.id
                        ...
                        <div className="flex-1 min-w-0">
                            {editingId === recording.id ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <button onClick={() => saveEdit(recording)} className="p-1 hover:text-green-400 text-slate-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-400/50 rounded" aria-label="Save edit"><Check size={16} /></button>
                                    <button onClick={cancelEdit} className="p-1 hover:text-red-400 text-slate-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400/50 rounded" aria-label="Cancel edit"><X size={16} /></button>
                                </div>
                            ) : (
                                <div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="opacity-0 group-hover:opacity-100 p-1 text-slate-500 hover:text-violet-400 transition-opacity focus:outline-none focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-violet-400/50 rounded"
                        ...
                        <div className="flex items-center gap-1">
                            <button
                                ...
                                className="p-2 text-slate-400 hover:text-violet-400 hover:bg-slate-700/50 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/50"
                            >
                                <Download size={18} />
                            </button>
                            <button
                                ...
                                className="p-2 text-slate-400 hover:text-red-400 hover:bg-slate-700/50 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400/50"
                            >
                                <Trash2 size={18} />
                            </button>
                        </div>
