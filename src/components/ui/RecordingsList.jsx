                ...
                <div key={recording.id} className="bg-slate-800/50 hover:bg-slate-800 border border-slate-700 rounded-xl p-4 transition-all group">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors flex-shrink-0 focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:outline-none ${playingId === recording.id
                            ...
                            {editingId === recording.id ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="p-1 hover:text-green-400 text-slate-400 focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:outline-none rounded"
                                    >
                                        <Check size={16} />
                                    </button>
                                    <button
                                        ...
                                        className="p-1 hover:text-red-400 text-slate-400 focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:outline-none rounded"
                                    >
                                        <X size={16} />
                                    </button>
                                </div>
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="opacity-0 group-hover:opacity-100 focus:opacity-100 p-1 text-slate-500 hover:text-violet-400 transition-opacity focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:outline-none rounded"
                                        >
                                            <Edit2 size={12} />
                                        </button>
                                    </div>
                        ...
                        <div className="flex items-center gap-1">
                            <button
                                ...
                                className="p-2 text-slate-400 hover:text-violet-400 hover:bg-slate-700/50 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:outline-none"
                            >
                                <Download size={18} />
                            </button>
                            <button
                                ...
                                className="p-2 text-slate-400 hover:text-red-400 hover:bg-slate-700/50 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:outline-none"
                            >
                                <Trash2 size={18} />
                            </button>
                        </div>
