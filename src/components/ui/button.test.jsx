...
describe("Button", () => {
  ...
  it("shows loading spinner when isLoading is true", () => {
    ...
    // Adjusted check: Button implementation usually renders children alongside spinner unless size='icon'
    // or hides them. Based on previous test, it seems it KEEPS children for default buttons.
    // Let's stick to checking spinner and disabled state.
    expect(screen.getByRole("button")).toBeDisabled();
  });
