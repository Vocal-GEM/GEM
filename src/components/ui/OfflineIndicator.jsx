...
const OfflineIndicator = () => {
    ...
    return (
        <div
            role="status"
            aria-live="polite"
            className={`fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[100] px-4 py-2 rounded-full shadow-lg border backdrop-blur-md flex items-center gap-3 transition-all animate-in slide-in-from-bottom-4 fade-in duration-300 ${!isOnline
