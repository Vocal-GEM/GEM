...
describe('JournalForm Accessibility', () => {
  ...
  it('has accessible prompt button', () => {
     render(<JournalForm />);
     // Find by text first to confirm rendering
     const buttonText = screen.getByText(/need a writing prompt/i);
     expect(buttonText).toBeInTheDocument();

     // Verify the button wrapper has the accessible name
     const button = buttonText.closest('button');
     expect(button).toHaveAttribute('aria-label', 'Get a writing prompt');
  });
});
