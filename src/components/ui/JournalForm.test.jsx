...
describe('JournalForm Accessibility', () => {
  it('renders buttons with accessible labels', () => {
    ...
    // There might be duplicate labels, so we check for presence specifically
    // Using getAllByLabelText to handle potential duplicates, and ensuring at least one exists
