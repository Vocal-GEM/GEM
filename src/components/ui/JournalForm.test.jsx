...
describe('JournalForm Accessibility', () => {
  it('renders buttons with accessible labels', () => {
    ...
    // The button might not have text but should have aria-label
    // The current implementation has aria-label="Start recording"
    expect(screen.getByRole('button', { name: /start recording/i })).toBeInTheDocument();

    // Check sliders have labels associated
    // Using getAllByLabelText because there might be duplicate labels in test (desktop/mobile) or multiple matches
  ...
  it('renders sentiment buttons with accessible labels', () => {
    ...
    // Check sentiment buttons (which use title and aria-label)
