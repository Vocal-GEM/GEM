    ...
    return (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={loadData} className="p-2 text-slate-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 rounded-lg" aria-label="Refresh voice analytics">
                    <RefreshCw size={18} />
                </button>
            </div>
