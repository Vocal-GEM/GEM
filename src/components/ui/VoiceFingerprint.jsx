    ...
    return (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={loadData} className="p-2 text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:outline-none" aria-label="Refresh voice analytics" title="Refresh data">
                    <RefreshCw size={18} />
                </button>
            </div>
