    ...
    return (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={loadData} className="p-2 text-slate-400 hover:text-white" aria-label="Refresh voice analytics">
                    <RefreshCw size={18} />
                </button>
            </div>

            {/* Tabs */}
            <div className="flex gap-2 mb-6" role="tablist" aria-label="Voice Analytics Tabs">
