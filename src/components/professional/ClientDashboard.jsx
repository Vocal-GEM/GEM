                    ...
                    <>
                        ...
                        <div className="h-16 border-b border-slate-700 flex items-center justify-between px-6 bg-slate-800/30">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button className="p-2 hover:bg-slate-700 rounded-lg transition-colors" aria-label="More options" title="More options"><MoreVertical size={20} /></button>
                            </div>
                        </div>
