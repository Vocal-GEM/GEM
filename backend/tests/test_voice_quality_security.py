...
class TestVoiceQualitySecurity(unittest.TestCase):
    def setUp(self):
        ...
        # Clean module from sys.modules if present to ensure re-import
    ...
    def test_manipulate_file_success(self):
        ...
        # We mock send_file to just return the path for verification
        with patch('backend.app.routes.voice_quality.send_file') as mock_send_file:
            mock_send_file.return_value = "sent file"
