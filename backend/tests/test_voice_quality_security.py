...
class TestVoiceQualitySecurity(unittest.TestCase):
    def setUp(self):
        ...
        # We need to patch modules BEFORE importing the blueprint because it imports at top level
        ...
        # Force reload of the module under test to apply mocks
    ...
    def test_manipulate_file_leakage(self):
        """
        Test that an internal error in manipulate_file returns a generic error message and does NOT leak details.
        """
        ...
        # Mock Sound object creation too just in case
        ...
        self.assertNotIn(secret_message, data.get('error', ''), "VULNERABILITY: Internal error details leaked to client!")
    ...
    def test_clean_audio_leakage(self):
        ...
        secret_message = "PATH_TRAVERSAL_FAILED_ETC_PASSWD"
