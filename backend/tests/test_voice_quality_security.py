...
# Clean sys.modules to start fresh (optional but good)
# We mock everything needed for voice_quality to allow import without running a full app
...
# Add repo root to sys.path so we can find the file
