...
class TestVoiceQualitySecurity(unittest.TestCase):
    ...
    def test_manipulate_file_error_handling(self):
        ...
        # Also need to mock parselmouth.Sound to avoid errors before the service call
        ...
        self.assertNotIn(secret_message, str(data), "Should NOT leak internal error details")
    ...
    def test_clean_audio_error_handling(self):
        """
        Test that clean_audio also handles errors securely.
        """
        file_content = b'fake audio data'
        file_storage = FileStorage(
            stream=BytesIO(file_content),
        ...
        secret_message = "INTERNAL_PATH_DISCLOSURE"
