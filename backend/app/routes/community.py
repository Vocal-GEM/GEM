...
def share_voice():
    ...
    try:
        ...
        # Use a secure upload folder separate from public uploads for raw files if configured
        secure_upload_folder = current_app.config.get('SECURE_UPLOAD_FOLDER', 'secure_uploads')
