    ...
    try:
        ...
        if tmp_path and os.path.exists(tmp_path):
            try:
                ...
                current_app.logger.error(f"Error removing temp file during exception cleanup: {cleanup_error}")
    ...
    try:
        ...
        if processed_path and os.path.exists(processed_path):
             try:
                ...
                current_app.logger.error(f"Error removing processed file during exception cleanup: {cleanup_error}")
