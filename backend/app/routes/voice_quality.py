    ...
    try:
        ...
        if tmp_path and os.path.exists(tmp_path):
            try:
                ...
                current_app.logger.warning(f"Failed to remove temp file {tmp_path}: {cleanup_error}")
    ...
    try:
        ...
        if processed_path and os.path.exists(processed_path):
             try:
                ...
                current_app.logger.warning(f"Failed to remove processed file {processed_path}: {cleanup_error}")
