...
def manipulate_file():
    ...
    try:
        ...
        import parselmouth
        # Note: manipulate_voice function needs to be imported or defined
        # Assuming it is in ..services.voicelab_service based on original code context
        # But import might fail if not available.
        try:
             from ..services.voicelab_service import manipulate_voice
        except ImportError:
             # Fallback or mock if service missing
             raise ImportError("Voice Lab service not available")
