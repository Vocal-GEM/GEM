...
def synthesize_speech():
    ...
    try:
        ...
        current_app.logger.error(f"ElevenLabs TTS synthesize error: {str(e)}")
...
def get_voices():
    ...
    try:
        ...
        from flask import current_app
        current_app.logger.error(f"ElevenLabs TTS get_voices error: {str(e)}")
        return jsonify({"error": "Failed to connect to ElevenLabs service.", "voices": []}), 502
