...
def validate_u_vowel(y, sr, f1_target=300, f2_target=800, tolerance=0.25):
    ...
    try:
        ...
        logger.error(f"Error in validate_u_vowel: {str(e)}")
        return {"is_valid": False, "error": "Internal analysis error"}
...
def analyze_file(path, goal_name="transfem_soft_slightly_breathy"):
    ...
    if _voicelab_available:
        try:
            ...
            logger.error(f"Error in voicelab analysis: {str(e)}")
            voicelab_data = {"error": "Internal analysis error"}
