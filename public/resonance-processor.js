...
class ResonanceProcessor extends AudioWorkletProcessor {
    ...
    analyze() {
        ...
        if (rms > this.threshold) {
            ...
            // const preEmphasized = DSP.preEmphasis(dsBuffer); // REMOVED: Pre-emphasis was skewing centroid too high
            const windowed = DSP.applyWindow(dsBuffer); // Use raw buffer for true spectral balance
            const lpcOrder = 14;
